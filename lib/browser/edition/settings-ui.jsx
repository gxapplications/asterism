      ...
      <div className='card'>
        {deferredInstallPrompt && (
          <div className='section left-align'>
            ...
            <p className='row'>
              <Button
                waves={waves} className={cx('marged col s12 m5 l7', theme.actions.secondary)}
        ...
        <div className='section left-align'>
          ...
          <div className='section card form'>
            <Switch
              s={12} name='continuousRecognition' checked={continuousRecognition}
            ...
            <br />
            <Select
              s={12} label={continuousRecognition ? 'Main language for speech keywords detection' : 'Speech language'}
        ...
        <div className={cx('card-reveal', theme.backgrounds.body)}>
          ...
          <div className='center-align circle-picker-container'>
            <CirclePicker
              width={340} circleSize={26} circleSpacing={-2} colors={this.colors}
