...
class DefaultMaterialTheme {
  constructor (localStorage) {
    ...
    this.backgrounds = {
      body: override.backgrounds.body || 'grey white-text',
      card: override.backgrounds.card || 'teal',
      highlight: '',
      editing: 'light-green'
    }

    this.actions = {
      primary: override.actions.primary || 'blue accent-4',
      secondary: override.actions.secondary || 'teal accent-4',
      inconspicuous: override.actions.inconspicuous || 'teal lighten-1',
