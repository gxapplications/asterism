...
class DefaultMaterialTheme {
  constructor (localStorage) {
    ...
    this.backgrounds = {
      body: ( override.backgrounds && override.backgrounds.body ) || 'grey white-text',
      card: ( override.backgrounds && override.backgrounds.card ) || 'teal',
      highlight: '',
      editing: 'light-green'
    }

    this.actions = {
      primary: ( override.actions && override.actions.primary ) || 'blue accent-4',
      secondary: ( override.actions && override.actions.secondary ) || 'teal accent-4',
      inconspicuous: ( override.actions && override.actions.inconspicuous ) || 'teal lighten-1',
