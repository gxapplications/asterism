...
const tokenTTL = 3 * 3600000 // 180 minutes
const longTokenTTL = tokenTTL * 24 * 5 // 15 days
      ...
      router.all('/login', (req, res) => {
        return this.isAuthenticationEnabled()
          .then((enabled) => {
            ...
            res.clearCookie('readOnly-access-token')
            res.clearCookie('password-encoder')
            res.cookie('password-encoder', this.passwordEncoder, { maxAge: 600000, signed: false })
