    ...
    return ServerScenarioActivator.scenariiService.getScenarioInstance(this.data.scenarioId)
      .then((scenario) => {
        switch (this.data.operation) {
          case 'activate':
            return ServerScenarioActivator.scenariiService.setActivationScenarioInstance(scenario, true, this.data.immediately)
          case 'deactivate':
            return ServerScenarioActivator.scenariiService.setActivationScenarioInstance(scenario, false, this.data.immediately)
          case 'switch':
          default: {
            const activation = scenario.activated
            return ServerScenarioActivator.scenariiService.setActivationScenarioInstance(scenario, !activation, this.data.immediately)
          }
        }
      })
  }
