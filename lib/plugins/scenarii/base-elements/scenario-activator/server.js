    ...
    return ServerScenarioActivator.scenariiService.getScenarioInstance(this.data.scenarioId)
      .then((scenario) => {
        switch (this.data.operation) {
          case 'activate':
            return ServerScenarioActivator.scenariiService.setActivationScenarioInstance(scenario, true, true)
          case 'deactivate':
            return ServerScenarioActivator.scenariiService.setActivationScenarioInstance(scenario, false, true)
          case 'switch':
          default: {
            const activation = scenario.activated
            return ServerScenarioActivator.scenariiService.setActivationScenarioInstance(scenario, !activation, true)
          }
        }
      })
  }
