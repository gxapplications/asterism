...
import BrowserFloatingLevelState from './floating-level-state/browser'
...
import BrowserWebPushNotificator from './web-push-notificator/browser'
import schemaWebPushNotificator from './web-push-notificator/schema'

import BrowserThermostatComfortForcer from './thermostat-comfort-forcer/browser'
import schemaThermostatComfortForcer from './thermostat-comfort-forcer/schema'

import BrowserHttpCallTrigger from './http-call-trigger/browser'
import schemaHttpCallTrigger from './http-call-trigger/schema'

import BrowserSurveyScenario from './survey-scenario/browser'
...
const baseElementTypes = () => ([
  ...
  { id: 'floating-level-state', browserClass: BrowserFloatingLevelState, dataSchema: schemaFloatingLevelState },
  ...
  { id: 'web-push-notificator', browserClass: BrowserWebPushNotificator, dataSchema: schemaWebPushNotificator },
  { id: 'thermostat-comfort-forcer', browserClass: BrowserThermostatComfortForcer, dataSchema: schemaThermostatComfortForcer },
  ...
  { id: 'http-call-trigger', browserClass: BrowserHttpCallTrigger, dataSchema: schemaHttpCallTrigger },
  ...
  { id: 'survey-scenario', browserClass: BrowserSurveyScenario, dataSchema: schemaSurveyScenario }
])
