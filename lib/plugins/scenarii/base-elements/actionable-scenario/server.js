...
export default class ServerActionableScenario extends ServerScenario {
    ...
    const triggerChain = (result) => {
      ...
      return new Promise((resolve, reject) => {
        ...
        ServerActionableScenario.scenariiService.getConditionInstance(this.data.executionCondition)
          ...
          .catch((error) => {
            ServerActionableScenario.logger.warn(`Scenario ${this.data.name}: Condition not found!`)
            reject(error)
          })
      })
        .then((result) => {
  ...
  afterUpdate () {
    ...
    return Promise.all([
      this.data.executionTrigger ? ServerActionableScenario.scenariiService.getTriggerInstance(this.data.executionTrigger)
      ...
      this.data.abortTrigger ? ServerActionableScenario.scenariiService.getTriggerInstance(this.data.abortTrigger)
        .then((abortTrigger) => {
