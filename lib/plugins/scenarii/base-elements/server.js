...
import ServerFloatingLevelState from './floating-level-state/server'
import schemaFloatingLevelState from './floating-level-state/schema'
...
import ServerThermostatComfortForcer from './thermostat-comfort-forcer/server'
import schemaThermostatComfortForcer from './thermostat-comfort-forcer/schema'

import ServerHttpCallTrigger from './http-call-trigger/server'
import schemaHttpCallTrigger from './http-call-trigger/schema'

import ServerSurveyScenario from './survey-scenario/server'
import schemaSurveyScenario from './survey-scenario/schema'
...
const baseElementTypes = ({ logger, scenariiService, dataHandler, notificationHandler }) => {
  ...
  ServerThermostatComfortForcer.scenariiService = scenariiService
  ServerThermostatComfortForcer.logger = logger
  ServerHttpCallTrigger.scenariiService = scenariiService
  ServerHttpCallTrigger.logger = logger
  ServerSurveyScenario.scenariiService = scenariiService
  ServerSurveyScenario.logger = logger
  ...
  return [
    ...
    { id: 'floating-level-state', serverClass: ServerFloatingLevelState, dataSchema: schemaFloatingLevelState },
    ...
    { id: 'thermostat-comfort-forcer', serverClass: ServerThermostatComfortForcer, dataSchema: schemaThermostatComfortForcer },
    ...
    { id: 'http-call-trigger', serverClass: ServerHttpCallTrigger, dataSchema: schemaHttpCallTrigger },
    ...
    { id: 'survey-scenario', serverClass: ServerSurveyScenario, dataSchema: schemaSurveyScenario }
  ]
}
