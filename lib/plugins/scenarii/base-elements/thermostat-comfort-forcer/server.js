  ...
  execute (executionId) {
    return ServerThermostatComfortForcer.scenariiService.getScenarioInstance(this.data.thermostatStateScenarioId)
      .then((thermostatStateScenario) => {
        ...
        ServerThermostatComfortForcer.scenariiService.setScenarioInstance(thermostatStateScenario)
        ServerThermostatComfortForcer.scenariiService.privateSocket.emit(
          'scenarioThermostatStateChanged',
          { instanceId: thermostatStateScenario.instanceId, data: thermostatStateScenario.data }
        )
