...
const middleware = (context, router) => {
  ...
  router.connectPlugin = (getServices) => {
    ...
    privateSocket.on('connection', (socket) => {
      ...
      socket.on('setActionInstance', (instanceData, parent, callback) => {
        _service.setActionData(instanceData, parent)
        .then(callback)
      })
      ...
      socket.on('setConditionInstance', (instanceData, parent, callback) => {
        _service.setConditionData(instanceData, parent)
        .then(callback)
      })
      ...
      socket.on('setTriggerInstance', (instanceData, parent, callback) => {
        _service.setTriggerData(instanceData, parent)
        .then(callback)
      })
      ...
      socket.on('setScenarioInstance', (instanceData, callback) => {
        _service.setScenarioData(instanceData)
        .then(callback)
      })
