...
const _setElementInstance = (logger, dataHandler, elementType, typeRepository, element) => {
...
export default class ScenariiService {
  ...
  getActionInstances (parent = undefined) {
    // TODO !0: send parent param (default undef for root actions)
  ...
  setConditionData (conditionData) {
    ...
    .then((condition) => _setElementInstance(this.logger, this.dataHandler, 'condition', this.conditions, condition))
  }
  ...
  setTriggerData (triggerData) {
    ...
    .then((trigger) => _setElementInstance(this.logger, this.dataHandler, 'trigger', this.triggers, trigger))
  }
